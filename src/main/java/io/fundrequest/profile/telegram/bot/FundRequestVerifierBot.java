        ...
        return Ability.builder()
                ...
                .action(ctx -> {
                    ...
                    try {
                        ...
                        if (execute.getStatus().equalsIgnoreCase("member") || execute.getStatus().equalsIgnoreCase("creator") || execute.getStatus().equalsIgnoreCase("left") || execute.getStatus().equalsIgnoreCase("administrator")) {
